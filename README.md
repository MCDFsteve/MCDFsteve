...
| 项目名 | 简介 | 技术栈 | Star |
| ------ | ------------------------------------------------------------ | ------ | ---- |
| [NipaPlay-Reload](https://github.com/MCDFsteve/NipaPlay-Reload) | 现代化 Flutter 跨平台播放器，支持弹幕/多字幕/多音轨 | Flutter | 1574 |
| [Misuzu Music](https://github.com/MCDFsteve/misuzumusic) | 跨平台本地音乐播放器，自动匹配封面和歌词 | Flutter | 77 |
